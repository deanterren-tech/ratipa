            ...
            <div className="mt-2">
              ...
              <div className="bg-white/20 border border-slate-200/40 rounded-[1.8rem] p-4.5 space-y-3.5 max-h-[450px] overflow-y-auto custom-scrollbar shadow-inner">
                {MODULES_LIST.map((m) => {
                  ...
                  const isExpanded = m.key === "planZagruzok" ? showZagruzokSubtabs : m.key === "currentPlanning" ? showPlanningSubtabs : false;
                  const toggleExpand = () => {
                     if (m.key === "planZagruzok") setShowZagruzokSubtabs(!showZagruzokSubtabs);
                     if (m.key === "currentPlanning") setShowPlanningSubtabs(!showPlanningSubtabs);
                  };
        ...
        {!isAdding && activeMainTab === "users" && selectedUser && (
          <div className="p-6 lg:p-8 flex flex-col h-full animate-fade-in overflow-y-auto">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5 mb-6">
              ...
              <div className="bg-white/45 border border-white/60 rounded-2xl p-4.5 shadow-xs flex flex-col justify-between">
                <div>
                  <label className="text-[9px] font-bold uppercase tracking-widest text-slate-400 font-mono mb-1.5 flex items-center gap-1.5 select-none">
